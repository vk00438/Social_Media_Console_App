...
public class PostCommand implements Command{
    private static final Pattern REGEX = Pattern.compile(Constants.REGEX_POST);
    ...
    public void execute(String commandLine) {
        ...
        if(currentUser!=null){
            ...
            if(matcher.find()){
                ...
                currentUser.addPostIdInUser(postId);
                ViewPostCommand viewPostCommand = new ViewPostCommand(repository);
                viewPostCommand.execute("view~"+postId);
            }
        }else{
